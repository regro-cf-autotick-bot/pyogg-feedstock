...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyogg-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13342&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyogg-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyogg` can be installed with:

```
conda install pyogg
```

It is possible to list all of the versions of `pyogg` available on your platform with:
